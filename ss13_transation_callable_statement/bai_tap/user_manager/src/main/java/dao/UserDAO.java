...
public class UserDAO implements IUserDAO {
    ...
    private static final String SORT_USERS_SQL = "select id,name,email,country from users order by name asc;";
    public UserDAO() {
    }
    ...
    public List<User> selectAllUsers() {
        ...
        try (Connection connection = getConnection();
             ...
             // Step 2:Create a statement using connection object
             CallableStatement callableStatement = connection.prepareCall("call get_list_user()");) {
